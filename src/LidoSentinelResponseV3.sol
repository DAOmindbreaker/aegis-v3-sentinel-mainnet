 ...
 * @notice On-chain response contract for LidoSentinelV3.
 *
 ...
 */
contract LidoSentinelResponseV3 {

    // ── Events ───────────────────────────────

    /// @notice Emitted for HIGH risk (shouldRespond triggered)
    ...
    /// @notice Emitted for MED risk (shouldAlert triggered)
    ...
    /// @notice Emitted for LOW risk or unknown levels
